<? $faq_left = carbon_get_post_meta(get_the_ID(), 'faq_serv_items_left' ); ?>
<? $faq_right = carbon_get_post_meta(get_the_ID(), 'faq_serv_items_right' ); ?>


<?

if(carbon_get_post_meta(get_the_ID(),'faq_serv_on')){
  
  ?>
<section class="faq-home">
  <div class="main-full head-section">
    <h2 class="title-section">
      <? echo carbon_get_post_meta(get_the_ID(), 'faq_serv_topic' ); ?>
    </h2>
    <div class="subtitle-section">
      <? echo carbon_get_post_meta(get_the_ID(), 'faq_serv_sub_topic' ); ?>
    </div>
  </div>
